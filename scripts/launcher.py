...
def start_server(minecraft_config: MinecraftConfig, system_config: SystemConfig):
    java_cmd = [
    "java",
    f"-Xms{minecraft_config.memory_size}",
    f"-Xmx{minecraft_config.memory_size}",
    "-Dlog4j2.formatMsgNoLookups=true",
    "-XX:+UseZGC", "-XX:+AlwaysPreTouch",
    "-XX:+UseStringDeduplication", "-XX:+UseCompactObjectHeaders",
